"""
Django settings for consorcio project.
...
SECRET_KEY = 'django-insecure-&x(sc230ta@843x0dlg(-n-@y@+a#-fhnih#afu!h0=#u5t(35'
...
WSGI_APPLICATION = 'consorcio.wsgi.application'
